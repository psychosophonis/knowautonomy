...
This was a good start. I still think wordpress was a good abtraction for an academic journal. It needed some tweaking and perhaps an adherence to the form of a traditional journal meant I built complexity into the form that made it more difficult for others to work on it. The real mistake was that the academic journal was a shitty abstraction for the a system of networked knowledge production and community. IMO - This was the problem. We were using the network - this agile, indeterminate, open beast to occupy a shitty abstraction rather than as the means to refactor and explore new abstractions for community and intellectual expression (as the mailing list serendipitously did).    
